...
// let remove all the images 
    ...
    humanDiv.innerHTML ="<img src='" + imageDatabase[humanImageChoice] + "'height=150 width150 style='box-shadow: 0px 10px 50px rgba(37, 50, 233, 1);'>"
    messageDiv.innerHTML = "<h1 style='color: " + finalMessage['color'] + "; font-size: 60px; padding: 30px; '>" + finalMessage ['message'] + "</h1>"
    botDiv.innerHTML ="<img src='" + imageDatabase[botImageChoice] + "'height=150 width150 style='box-shadow: 0px 10px 50px rgba(243, 50, 24, 1);'>"
